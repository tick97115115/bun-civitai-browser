...
export const CreatorFindFirstSelectSchema: z.ZodType<Prisma.CreatorSelect> = z.object({
...
export const CreatorFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    username: z.boolean().optional(),
    link: z.boolean().optional(),
    image: z.boolean().optional(),
...
export const CreatorFindFirstSchema: z.ZodType<Prisma.CreatorFindFirstArgs> = z.object({ select: CreatorFindFirstSelectSchema.optional(), include: CreatorIncludeObjectSchema.optional(), orderBy: z.union([CreatorOrderByWithRelationInputObjectSchema, CreatorOrderByWithRelationInputObjectSchema.array()]).optional(), where: CreatorWhereInputObjectSchema.optional(), cursor: CreatorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CreatorScalarFieldEnumSchema, CreatorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CreatorFindFirstArgs>;

export const CreatorFindFirstZodSchema = z.object({ select: CreatorFindFirstSelectSchema.optional(), include: CreatorIncludeObjectSchema.optional(), orderBy: z.union([CreatorOrderByWithRelationInputObjectSchema, CreatorOrderByWithRelationInputObjectSchema.array()]).optional(), where: CreatorWhereInputObjectSchema.optional(), cursor: CreatorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CreatorScalarFieldEnumSchema, CreatorScalarFieldEnumSchema.array()]).optional() }).strict();