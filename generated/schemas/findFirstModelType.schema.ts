...
export const ModelTypeFindFirstSelectSchema: z.ZodType<Prisma.ModelTypeSelect> = z.object({
...
export const ModelTypeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    models: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const ModelTypeFindFirstSchema: z.ZodType<Prisma.ModelTypeFindFirstArgs> = z.object({ select: ModelTypeFindFirstSelectSchema.optional(), include: ModelTypeIncludeObjectSchema.optional(), orderBy: z.union([ModelTypeOrderByWithRelationInputObjectSchema, ModelTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelTypeWhereInputObjectSchema.optional(), cursor: ModelTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelTypeScalarFieldEnumSchema, ModelTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelTypeFindFirstArgs>;

export const ModelTypeFindFirstZodSchema = z.object({ select: ModelTypeFindFirstSelectSchema.optional(), include: ModelTypeIncludeObjectSchema.optional(), orderBy: z.union([ModelTypeOrderByWithRelationInputObjectSchema, ModelTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelTypeWhereInputObjectSchema.optional(), cursor: ModelTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelTypeScalarFieldEnumSchema, ModelTypeScalarFieldEnumSchema.array()]).optional() }).strict();