...
export const ModelVersionFindFirstSelectSchema: z.ZodType<Prisma.ModelVersionSelect> = z.object({
...
export const ModelVersionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    modelId: z.boolean().optional(),
    name: z.boolean().optional(),
    baseModelId: z.boolean().optional(),
...
export const ModelVersionFindFirstSchema: z.ZodType<Prisma.ModelVersionFindFirstArgs> = z.object({ select: ModelVersionFindFirstSelectSchema.optional(), include: ModelVersionIncludeObjectSchema.optional(), orderBy: z.union([ModelVersionOrderByWithRelationInputObjectSchema, ModelVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelVersionWhereInputObjectSchema.optional(), cursor: ModelVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelVersionScalarFieldEnumSchema, ModelVersionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelVersionFindFirstArgs>;

export const ModelVersionFindFirstZodSchema = z.object({ select: ModelVersionFindFirstSelectSchema.optional(), include: ModelVersionIncludeObjectSchema.optional(), orderBy: z.union([ModelVersionOrderByWithRelationInputObjectSchema, ModelVersionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelVersionWhereInputObjectSchema.optional(), cursor: ModelVersionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelVersionScalarFieldEnumSchema, ModelVersionScalarFieldEnumSchema.array()]).optional() }).strict();