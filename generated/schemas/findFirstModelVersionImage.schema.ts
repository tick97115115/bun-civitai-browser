...
export const ModelVersionImageFindFirstSelectSchema: z.ZodType<Prisma.ModelVersionImageSelect> = z.object({
...
export const ModelVersionImageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    url: z.boolean().optional(),
    nsfwLevel: z.boolean().optional(),
    width: z.boolean().optional(),
...
export const ModelVersionImageFindFirstSchema: z.ZodType<Prisma.ModelVersionImageFindFirstArgs> = z.object({ select: ModelVersionImageFindFirstSelectSchema.optional(), include: ModelVersionImageIncludeObjectSchema.optional(), orderBy: z.union([ModelVersionImageOrderByWithRelationInputObjectSchema, ModelVersionImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelVersionImageWhereInputObjectSchema.optional(), cursor: ModelVersionImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelVersionImageScalarFieldEnumSchema, ModelVersionImageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelVersionImageFindFirstArgs>;

export const ModelVersionImageFindFirstZodSchema = z.object({ select: ModelVersionImageFindFirstSelectSchema.optional(), include: ModelVersionImageIncludeObjectSchema.optional(), orderBy: z.union([ModelVersionImageOrderByWithRelationInputObjectSchema, ModelVersionImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelVersionImageWhereInputObjectSchema.optional(), cursor: ModelVersionImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelVersionImageScalarFieldEnumSchema, ModelVersionImageScalarFieldEnumSchema.array()]).optional() }).strict();