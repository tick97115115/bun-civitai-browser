...
export const ModelVersionImageFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ModelVersionImageSelect> = z.object({
...
export const ModelVersionImageFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    url: z.boolean().optional(),
    nsfwLevel: z.boolean().optional(),
    width: z.boolean().optional(),
...
export const ModelVersionImageFindFirstOrThrowSchema: z.ZodType<Prisma.ModelVersionImageFindFirstOrThrowArgs> = z.object({ select: ModelVersionImageFindFirstOrThrowSelectSchema.optional(), include: ModelVersionImageIncludeObjectSchema.optional(), orderBy: z.union([ModelVersionImageOrderByWithRelationInputObjectSchema, ModelVersionImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelVersionImageWhereInputObjectSchema.optional(), cursor: ModelVersionImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelVersionImageScalarFieldEnumSchema, ModelVersionImageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelVersionImageFindFirstOrThrowArgs>;

export const ModelVersionImageFindFirstOrThrowZodSchema = z.object({ select: ModelVersionImageFindFirstOrThrowSelectSchema.optional(), include: ModelVersionImageIncludeObjectSchema.optional(), orderBy: z.union([ModelVersionImageOrderByWithRelationInputObjectSchema, ModelVersionImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelVersionImageWhereInputObjectSchema.optional(), cursor: ModelVersionImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelVersionImageScalarFieldEnumSchema, ModelVersionImageScalarFieldEnumSchema.array()]).optional() }).strict();