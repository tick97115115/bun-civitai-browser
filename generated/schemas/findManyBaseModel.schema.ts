...
export const BaseModelFindManySelectSchema: z.ZodType<Prisma.BaseModelSelect> = z.object({
...
export const BaseModelFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    modelVersions: z.boolean().optional(),
    baseModelTypes: z.boolean().optional(),
