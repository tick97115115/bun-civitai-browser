...
export const ModelVersionFileFindUniqueSchema: z.ZodType<Prisma.ModelVersionFileFindUniqueArgs> = z.object({ select: ModelVersionFileSelectObjectSchema.optional(), include: ModelVersionFileIncludeObjectSchema.optional(), where: ModelVersionFileWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ModelVersionFileFindUniqueArgs>;

export const ModelVersionFileFindUniqueZodSchema = z.object({ select: ModelVersionFileSelectObjectSchema.optional(), include: ModelVersionFileIncludeObjectSchema.optional(), where: ModelVersionFileWhereUniqueInputObjectSchema }).strict();